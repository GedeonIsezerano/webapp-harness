...
- Give every task a stable unused ID, a priority, explicit dependencies,
  testable acceptance criteria, existing verification profile names, and
  narrow allowed and forbidden paths.
...
- Require browser validation for user-visible behavior. Do not claim a visual
  or browser gap was observed unless rendered application evidence was
  actually collected.
